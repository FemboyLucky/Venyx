...
local objects = {}
local themes = {
	Background = Color3.fromRGB(255, 200, 240), -- Soft pastel pink
	Glow = Color3.fromRGB(255, 175, 220),      -- Gentle glowing pink
	Accent = Color3.fromRGB(255, 140, 210),    -- Bright pink accent
	LightContrast = Color3.fromRGB(255, 225, 245), -- Slightly lighter pink
	DarkContrast = Color3.fromRGB(240, 180, 230),  -- Slightly darker pink
